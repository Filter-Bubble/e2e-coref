    ...
    with tf.Session() as session:
        while True:
            ...
            if ckpt and ckpt.model_checkpoint_path and ckpt.model_checkpoint_path not in evaluated_checkpoints:
                ...
                copy_checkpoint(ckpt.model_checkpoint_path,
                                tmp_checkpoint_path)

                global_step = int(checkpoint_pattern.match(
                ...
                sleep_time = 10
            print("Waiting for {} seconds before looking for next checkpoint.".format(
                sleep_time))
